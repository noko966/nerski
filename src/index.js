...
function aa(en){
  const _vd = verbalData(en);
  let res = `
  .class{
    --${_vd.nameBg}: var(--background_1);
    --${_vd.nameBgHov}: var(--background_1);
    --${_vd.nameBg2}: var(--background_1);
    --${_vd.nameBg2Hov}: var(--background_1);
    --${_vd.nameBg3}: var(--background_1);
    --${_vd.nameBg3Hov}: var(--background_1);
    --${_vd.nameTxt}: "var(--text_1)";
    --${_vd.nameTxt2}: "var(--text_2)";
    --${_vd.nameTxt3}: "var(--text_3)";
  }
    `;
