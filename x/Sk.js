...
<path d="M7.5,13.5h8c0.6,0,1-0.4,1-1v-8c0-0.6-0.4-1-1-1h-8c-0.6,0-1,0.4-1,1v8C6.5,13.1,6.9,13.5,7.5,13.5z M13.5,16.5
  ...
  stylerCreateState(selector, el) {
    ...
    if (props.includes("Bg")) {
      this.stylerSkin[selector].colors.background =
        computedStyles.getPropertyValue(`--${essence}Bg`);
    }
    if (props.includes("Txt")) {
      this.stylerSkin[selector].colors.text_1 = computedStyles.getPropertyValue(
        `--${essence}Txt`
      );
    }
    if (props.includes("Txt2")) {
      this.stylerSkin[selector].colors.text_2 = computedStyles.getPropertyValue(
        `--${essence}Txt2`
      );
    }
  }
  ...
  createStylerPickers() {
    ...
    const stylerPickerCB = (e) => {
      this.handlePicker(e, null, null, (color) => console.log(color));
    };
